...
<main role="main" class="container">
  ...
  <div class="starter-template">
    ...
    <table class="table table-sm table-dark">
        ...
        <?php 
        $i = 1;
        foreach ($data->programInfo as $valueProgram) {
        ?>
            <tr>
            <th scope="row"><?php echo $i; ?></th>
            <td><?php echo $valueProgram->name; ?></td>
            <td><?php echo $valueProgram->semesters; ?></td>
            <td><?php echo $valueProgram->title; ?></td>
            <td><?php echo $valueProgram->credits; ?></td>
            <td><a href="viewProgram.php?id=<?php echo $valueProgram->programId; ?>"><button type="button" class="btn btn-info">View</button></a><a href="updateProgram.php?id=<?php echo $valueProgram->programId; ?>"><button type="button" class="btn btn-primary">Edit</button></a><a href="deleteProgram.php?id=<?php echo $valueProgram->programId; ?>"><button type="button" class="btn btn-danger">Delete</button></a></td>
            </tr>
        <?php 
          $i++;
        }
