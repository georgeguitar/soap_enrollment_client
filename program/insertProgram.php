...
<h1>Insert Program</h1>
    <form action="insertedProgram.php" method="post">
  <div class="form-group">
    <label for="inputName">Name</label>
    <input type="text" class="form-control" id="inputName" name="inputName" placeholder="Name Program">    
  </div>
  <div class="form-group">
    <label for="inputSemesters">Semesters</label>
    <input type="text" class="form-control" id="inputSemesters" name="inputSemesters" placeholder="Semesters">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="inputCredits" name="inputCredits" placeholder="Credits">
  </div>
