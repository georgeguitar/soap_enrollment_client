...
$client = new SoapClient(DIRECCION_BASE_PROGRAM);

/** getProgramById **/
$data = $client->getProgramById(array('programId' => $_GET['id']));
...
<h1>Update Program</h1>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="inputName" name="inputName" value="<?php echo $data->programInfo->name; ?>">    
  </div>
  <div class="form-group">
    <label for="inputSemesters">Semesters</label>
    <input type="text" class="form-control" id="inputSemesters" name="inputSemesters" value="<?php echo $data->programInfo->semesters; ?>">
  </div>
  <div class="form-group">
    <label for="inputTitle">Title</label>
    <input type="text" class="form-control" id="inputTitle" name="inputTitle" value="<?php echo $data->programInfo->title; ?>">
  </div>
  <div class="form-group">
    <label for="inputCredits">Credits</label>
    <input type="text" class="form-control" id="inputCredits" name="inputCredits" value="<?php echo $data->programInfo->credits; ?>">
  </div>
  <input type=hidden id="inputID" name="inputID" value="<?php echo $data->programInfo->programId; ?>">
