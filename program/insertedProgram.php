...
$info = array(
    ...
    'semesters' => $_POST['inputSemesters'],
    'title' => $_POST['inputTitle'],
    'credits' => $_POST['inputCredits']
);

$data = $client->addProgram($info);
//var_dump($data);
?>
<!doctype html>
<html lang="en">
...
<p><?php echo $data->serviceStatusProgram->message; ?></p>
    <div class="form-group">
    <h4>Name</h4>    
    <p><?php echo $data->programInfo->name; ?></p>
  </div>
  <div class="form-group">
  <h4>Semesters</h4>
  <p><?php echo $data->programInfo->semesters; ?></p>
  </div>
  <div class="form-group">
    <h4>Title</h4>    
    <p><?php echo $data->programInfo->title; ?></p>
  </div>  
  <div class="form-group">
    <h4>Credits</h4>    
    <p><?php echo $data->programInfo->credits; ?></p>
  </div>
</main><!-- /.container -->
