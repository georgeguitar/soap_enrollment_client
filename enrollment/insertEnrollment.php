...
<h1>Insert Enrollment</h1>
    <form action="insertedEnrollment.php" method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="inputPeriod" name="inputPeriod" placeholder="Period">
  </div>
  <div class="form-group">
    <label for="inputLevel">Level</label>
    <input type="text" class="form-control" id="inputLevel" name="inputLevel" placeholder="Level">
  </div>
  <div class="form-group">
