...
<h1>Inserted Enrollment</h1>
<p><?php echo $data->serviceStatusEnrollment->message; ?></p>
    <div class="form-group">
    <h4>Year</h4>    
    <p><?php echo $data->enrollmentInfo->year; ?></p>
  </div>
  <div class="form-group">
  <h4>Period</h4>
  <p><?php echo $data->enrollmentInfo->period; ?></p>
  </div>
  <div class="form-group">
    <h4>Level</h4>    
    <p><?php echo $data->enrollmentInfo->level; ?></p>
  </div>  
  <div class="form-group">
    <h4>Date Enrollment</h4>    
