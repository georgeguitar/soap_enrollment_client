...
<main role="main" class="container">
  ...
  <div class="starter-template">
    ...
    <div class="text-right">
        <button type="button" class="btn btn-primary" type="submit" onclick="location.href='insertEnrollment.php'">Insert Enrollment</button>
        <p></p>
    </div>
    <table class="table table-sm table-dark">
        ...
        <?php 
        $i = 1;
        foreach ($data->enrollmentInfo as $valueEnrollment) {
        ?>
            <tr>
