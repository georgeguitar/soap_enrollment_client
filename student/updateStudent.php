...
/** getStudentById **/
$data = $client->getStudentById(array('studentId' => $_GET['id']));
...
<h1>Update Student</h1>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="inputName" name="inputName" value="<?php echo $data->studentInfo->name; ?>">    
  </div>
  <div class="form-group">
    <label for="inputSurname">Surname</label>
    <input type="text" class="form-control" id="inputSurname" name="inputSurname" value="<?php echo $data->studentInfo->surname; ?>">
  </div>
  <div class="form-group">
    <label for="inputAddress">Address</label>
    <input type="text" class="form-control" id="inputAddress" name="inputAddress" value="<?php echo $data->studentInfo->address; ?>">
  </div>
  <div class="form-group">
    <label for="inputTelephone">Telephone</label>
    <input type="text" class="form-control" id="inputTelephone" name="inputTelephone" value="<?php echo $data->studentInfo->telephone; ?>">
  </div>
  <input type=hidden id="inputID" name="inputID" value="<?php echo $data->studentInfo->studentId; ?>">
